...
const StairLayout = ({ setAppState, appState }) => {
  ...
  const secondtSelectDefaultValueRedux = useSelector(selectDefaultValueTwo);
  ...
  const handleSelectShape2 = (event) => {
    ...
    if (selectedValue === QUARTER_LANDING || selectedValue === THREE_WINDER) {
      ...
      dispatch(setHalfLandingTurn("TwoHalfLandingRightLeft"));
    }

    if (selectedValue === HALF_LANDING) {
      dispatch(setHalfLandingTurn("TwoHalfLandingRightLeftops"));
      dispatch(setSelectDefaultValue2(HALF_LANDING));
    }
  };
    ...
    <div>
      ...
      <Paper elevation={3} sx={TurnPaperStyle}>
        ...
        <Div sx={TurnFlex}>
          <Appheading>Type </Appheading>
          <ShapesSelect
            defaultShape={secondtSelectDefaultValueRedux}
            handleSelectShape={handleSelectShape2}
          />
        </Div>
        <Div sx={TurnFlex}>
          <Appheading>Treads before turn:</Appheading>

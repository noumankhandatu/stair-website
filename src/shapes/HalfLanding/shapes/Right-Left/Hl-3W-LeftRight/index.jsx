...
const HalfLandingThreeWinderLeftRight = () => {
  // states
      ...
      <Grid container>
        ...
        <Grid sx={{ textAlign: "center" }} xs={9}>
          <svg width={981} height={700}>
            ...
            <g transform="translate (287.2985611510792,542.3741007194244) rotate(180) scale(-0.2517985611510791,0.2517985611510791)">
              {" "}
              <g>
                ...
                <g transform="translate(1365.5 223.5)  rotate(270)">
                  <g>
                    <g transform="translate(-413.5 0)  rotate(0)">
                      {" "}
                      <rect
                ...
                <g transform="translate(2031.5 223.5)  rotate(270)">
                  <g transform="translate(-413.5 0)  rotate(0)">
                    {" "}
                    <rect
                      x={0}
...
export default HalfLandingThreeWinderLeftRight;

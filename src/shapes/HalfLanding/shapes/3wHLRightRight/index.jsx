...
const ThreeWinderHalfLandingRightRighttShape = () => {
  // states
      ...
      <Grid container>
        ...
        <Grid sx={{ textAlign: "center" }} xs={9}>
          <svg width={981} height={700}>
            ...
            <g transform="translate (342.7894590072504,586.8014500836587) rotate(180) scale(-0.27328499721137756,0.27328499721137756)">
              {" "}
              <g>
                ...
                <g transform="translate(664.5 407.5)  rotate(90)">
                  <g>
                    <g transform="translate(-413.5 0)  rotate(0)">
                      {" "}
                      <rect
                ...
                <g transform="translate(-1.5 407.5)  rotate(90)">
                  <g transform="translate(-413.5 0)  rotate(0)">
                    {" "}
                    <rect
                      x={0}
...
export default ThreeWinderHalfLandingRightRighttShape;

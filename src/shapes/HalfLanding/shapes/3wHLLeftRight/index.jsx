...
const ThreeWinderHalfLandingLeftRightShape = () => {
  // states
      ...
      <Grid container>
        ...
        <Grid sx={{ textAlign: "center" }} xs={9}>
          <svg width={981} height={700}>
            ...
            <g transform="translate (588.3370890284448,592.1038049501292) rotate(180) scale(-0.1810121906169191,0.1810121906169191)">
              {" "}
              <g>
                ...
                <g transform="translate(-664.5 2253.5)  rotate(270)">
                  <g>
                    <g transform="translate(-413.5 0)  rotate(0)">
                      {" "}
                      <rect
                ...
                <g transform="translate(1.5 2253.5)  rotate(270)">
                  <g transform="translate(-413.5 0)  rotate(0)">
                    {" "}
                    <rect
                      x={0}
...
export default ThreeWinderHalfLandingLeftRightShape;

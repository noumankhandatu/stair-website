...
const HalfLandingRight = () => {
  return (
    <Grid container>
      ...
      <Grid xs={8}>
        <div data-v-4a24d568="" className="view-wrapper">
          {/**/} {/**/} {/**/} {/**/} {/**/}{" "}
          <div className="b-overlay-wrap position-relative" id="svgWrap" style={{ height: 700 }}>
            <div className="">
              <div style={{ height: 700 }}>
                <div>
                  <svg width={1034} height={700}>
                    ...
                    <g transform="translate (422.7770410277663,457.72689598010777) rotate(180) scale(-0.2030667219229175,0.2030667219229175)">
                      {" "}
                      <g>
